#!/usr/bin/env python3
"""Compatibility wrapper that delegates to the timestamped evening2 script."""
...
IMPLEMENTATION_FILENAME = "25-11-10-13_evening2.py"
IMPLEMENTATION_MODULE = "dev_test.evening2_impl"
